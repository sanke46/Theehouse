...
//        intent.putExtra(EXTRA_TITLE, "Grabl, Grable, Grable");
//        startActivityForResult(intent, REQUEST_FAVORITE);

        // Implicity intent
        Intent intent = new Intent(Intent.ACTION_VIEW);
        Uri geoLocation = Uri.parse("geo:0,0?q=45.548700, -122.667933(ThreeHouse)");
    ...
    protected void onResume() {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(mLocarReceiver, customFilter);
    }
    ...
    private BroadcastReceiver mLocarReceiver = new BroadcastReceiver() {
        @Override
